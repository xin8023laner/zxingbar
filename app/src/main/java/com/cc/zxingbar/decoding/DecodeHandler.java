...
import com.cc.zxingbar.ZbarManager;
...
final class DecodeHandler extends Handler {
	...
	BaseScanActivity activity = null;

//	DecodeHandler(BaseScanAllActivity activity) {
//		this.activity = activity;
//	}
private final MultiFormatReader multiFormatReader;

	DecodeHandler(BaseScanActivity activity, Hashtable<DecodeHintType, Object> hints) {
